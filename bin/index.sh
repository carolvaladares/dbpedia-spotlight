...
export SPOTLIGHT_WORKSPACE="/home/ubuntu/dbpedia-spotlight"
export INDEX_CONFIG_FILE=$SPOTLIGHT_WORKSPACE/conf/indexing.properties
export SERVER_CONFIG_FILE=$SPOTLIGHT_WORKSPACE/conf/server.properties
export lang_i18n=pt
...
cp $DBPEDIA_WORKSPACE/data/output/$lang_i18n/surfaceForms-fromOccs-thresh3.tsv $DBPEDIA_WORKSPACE/data/output/$lang_i18n/surfaceForms-fromTitRedDis.tsv
...
mvn scala:run -Dlauncher=IndexMergedOccurrences "-DjavaOpts.Xmx=$JAVA_XMX" "-DaddArgs=$DBPEDIA_WORKSPACE/data/output/$lang_i18n/occs.uriSorted.tsv"
...
echo -e "Adding Surface Forms to index...\n"
 mvn scala:run -Dlauncher=AddSurfaceFormsToIndex "-DjavaOpts.Xmx=$JAVA_XMX"
# or
...
#    mvn scala:run -Dlauncher=ComplementTypes "-DjavaOpts.Xmx=$JAVA_XMX"
#fi
